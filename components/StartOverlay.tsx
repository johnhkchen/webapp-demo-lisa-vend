 ...
 * overlay never intercepts input. It pulses to read as an arcade attract prompt and uses the app's
 * cyan→fuchsia→violet gradient so it belongs to the same system as the title and the other overlays.
 *
